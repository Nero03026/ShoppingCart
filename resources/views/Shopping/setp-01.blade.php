...
<section class="w-[100%] flex flex-row">
    <div class="w-[60%] flex flex-col">
        <div class="w-[100%] flex flex-row">
            ...
            <div class="flex justify-center items-center">
                ...
                <input class="w-[35px] h-[35px] flex justify-center items-center text-center" type="text" value="1">
                <div class="w-[35px] h-[35px] flex justify-center items-center cursor-pointer border-2">+</div>
            </div>
    ...
    <div class="w-[40%] p-[30px] flex flex-col gap-[25px] border-2">
        <div class="">
            ...
            <form class="mb-[10px]" action="{{route('order.store01')}}" method="POST">
                @csrf
                <button
        ...
        <div>
            ...
            <form class="mb-[5px] flex flex-col gap-[8px]" action="">
                @csrf
